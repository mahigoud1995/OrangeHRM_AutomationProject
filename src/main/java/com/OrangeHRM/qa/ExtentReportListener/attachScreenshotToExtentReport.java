...
public class attachScreenshotToExtentReport {
	...
	public void getScreenshot() throws IOException {
		...
		.addScreenCaptureFromPath(localPath)
		.addScreenCaptureFromPath(localPath, "HomePage -- > Taken By regular method")
		.addScreenCaptureFromBase64String(base64Path)
		.addScreenCaptureFromBase64String(base64Path, "HomePage 2--> Tahen from the base 64");
